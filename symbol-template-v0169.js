...
function exportElectricalTemplateLibrary(){
  const payload={schema:'dwg-sketch-electrical-symbol-library',schemaVersion:2,libraryVersion:'1.0.0',appVersion:'0.22.16',exportedAt:new Date().toISOString(),templates:Object.values(customElectricalSymbolTemplates)};
