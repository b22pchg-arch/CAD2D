/* DWG Sketch PWA V0.21.0 - direct DWG reader worker.
...
const DWG_WORKER_VERSION = '0.21.0';
...
function convertDatabase(database, fileName, meta = {}, rawTables = null) {
  ...
  return {
    ...
    dwgImport: {
      engine: '@mlightcad/libredwg-web 0.7.9 local + PWA color/font/hatch/lwpolyline adapter 0.21.0',
      workerVersion: DWG_WORKER_VERSION,
      engineVersion: DWG_ENGINE_VERSION,
      engineSource: DWG_ENGINE_SOURCE,
