/* DWG Sketch PWA V0.20.1 - direct DWG reader worker.
...
const DWG_WORKER_VERSION = '0.20.1';
...
function convertDatabase(database, fileName, meta = {}, rawTables = null) {
  ...
  return {
    ...
    dwgImport: {
      engine: '@mlightcad/libredwg-web 0.7.9 local + PWA color/font/hatch/lwpolyline adapter 0.20.1',
      workerVersion: DWG_WORKER_VERSION,
      engineVersion: DWG_ENGINE_VERSION,
      engineSource: DWG_ENGINE_SOURCE,
