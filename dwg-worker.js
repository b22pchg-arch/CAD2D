/* DWG Sketch PWA V0.18.6 - direct DWG reader worker.
...
const DWG_WORKER_VERSION = '0.18.6';
...
function convertDatabase(database, fileName, meta = {}, rawTables = null) {
  ...
  return {
    ...
    dwgImport: {
      engine: '@mlightcad/libredwg-web 0.7.9 local + PWA color/font/hatch/lwpolyline adapter 0.18.6',
      workerVersion: DWG_WORKER_VERSION,
      engineVersion: DWG_ENGINE_VERSION,
      engineSource: DWG_ENGINE_SOURCE,
