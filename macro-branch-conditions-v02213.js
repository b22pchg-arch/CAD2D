...
'use strict';
(()=>{
 const VERSION='0.22.13',MODES=['Always','IfRoleExists','IfRoleMissing','IfCountAtLeast','IfCountAtMost','IfCountEquals','IfKindOverlay','IfKindCad','IfKindMixed'],ROLES=['SameAsInput','CurrentSelection','Source','Target','Reference','Result','Result1','Result2','Result3'];
 ...
 window.DwgSketchMacroBranchConditionsV02213={version:VERSION,modes:[...MODES],roles:[...ROLES],validateSyntax,evaluate,roleOf};
})();
